<template>
    <nav class="bg-white border-gray-200 px-2 mb-6 md:mb-12 shadow-sm sm:px-4 py-2.5 rounded dark:bg-neutral-900">
        <div class="container flex flex-wrap justify-between items-center mx-auto">
            <a href="https://flowbite.com/" class="flex items-center">
                <span class="text-black self-center text-xl font-semibold whitespace-nowrap dark:text-white">Silverhand</span>
            </a>
            <div class="flex md:order-2 items-center">
                ...
                <div class="hidden relative md:block">
                    ...
                    <input type="text" id="search-navbar" class="block p-2 pl-10 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-neutral-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search...">
                </div>
